...
## Open structural question raised by Andy's own words (2026-08-01) — needs a decision before building

Andy referred to "the LEISURE TRAVEL PAGE" as a live destination for real group content he's bringing (a Wisconsin-to-Thailand trip for a group like "Jenny's" — friends/family/small clubs/wedding parties, explicitly **not** "the super rich folks" Bespoke implies) — as if Leisure still exists as its own public page. It doesn't: per the 2026-07-30 "choose the best option" decision, Leisure was dissolved into Bespoke, which stays password-gated. That means, as things stand, this exact kind of content (the audience Andy is describing) would end up gated behind LuxeAccess, which seems to conflict with what he's describing wanting to publish. **This needs a real decision, not a guess:** does non-Bespoke "leisure" group content need a public home again (revive a public Leisure page, or fold this into the public Groups page instead), or is Andy's mental model just not yet caught up to the rebrand's page structure? Worth clarifying directly before building the Wisconsin/Thailand tour content, the wedding/friend-group Groups categories, or the "How To" guides concept (see below) anywhere.

## New real content/requests from Andy, not yet built (2026-08-01)

- **Groups page:** add "WEDDINGS, FRIEND GROUPS, CURATED EVENTS" near the top alongside the existing corporate/incentive categories, and a new slogan: **"Travel Together. Go Deeper."** Straightforward to add once the structural question above is settled (may affect whether this goes on Groups as-is or needs its own section).
- **A "How To" concept for small-group trips**, Andy's own framing: destinations he wants to seed first are Thailand, Nepal, Tahiti, Hidden Mexico, Greece Mainland Coasts, Istanbul for Beginners, with copy along the lines of "It's simple — get a group of your friends or family together (minimum 8, maximum 14), and we curate an adventure that will exceed your expectations. Contact Andy to start building." No page/section exists for this yet — needs a placement decision (own page? part of Groups? part of wherever "leisure" content lives?).
